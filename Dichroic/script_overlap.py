...
#mg.SetTitle("cluster_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+"; signal efficiency; 1 - background efficiency")
        mg.SetTitle("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error; signal efficiency; 1 - background efficiency")
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
        ...
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error.pdf")
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error.eps")
