...
for k in range(0,9):
    for j in range(0,4):
        ...
        f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[k]+"_tau32_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        ...
        G1=f1.Get("Graph")
        f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[k]+"_tau32b0b0_tt_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        ...
        G2=f2.Get("Graph")
        f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[k]+"_tau32b2b0_tt_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
...
#mg.SetTitle("cluster_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+"; signal efficiency; 1 - background efficiency")
        mg.SetTitle("cluster_"+detector_size_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error_tau32_grooming_compare_tt;signal efficiency; 1 - background efficiency")
...
#           leg1.SetBorderSize(0)
        ...
        leg.AddEntry(G2,"tagging groomed  {#beta=0}/{#beta=0}","l")
        leg.AddEntry(G3,"Dichroic groomed {#beta=2}/{#beta=0}","l")
        leg.AddEntry(G4,"full groomed     {#beta=2}/{#beta=2}","l")
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
        ...
        c.Print("cluster_"+detector_size_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error_tau32_grooming_compare_tt.pdf")
        c.Print("cluster_"+detector_size_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error_tau32_grooming_compare_tt.eps")
