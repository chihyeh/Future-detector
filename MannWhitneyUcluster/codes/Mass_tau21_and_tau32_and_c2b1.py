    ...
    if(variable[k]=="tau21"):
        for m in range(0,4):
            for i in range(0,3):
                ...
                f=TFile("Dis_cluster_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff.root","RECREATE")
                gr.Write()
                c.Print("Dis_cluster_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff.eps")
