...
if(variable[k]=="tau21"):
    ...
    c.Print("Rawhit_0.25GeV_tau21_summary_U.pdf")
...
if(variable[k+1]=="tau32"):
    ...
    c.Print("Rawhit_0.25GeV_tau32_summary_U.pdf")
...
if(variable[k+2]=="c2b1"):
    ...
    c.Print("Rawhit_0.25GeV_c2b1_summary_U.pdf")
    c.Print("Rawhit_0.25GeV_c2b1_summary_U.eps")
