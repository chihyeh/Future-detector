...
for k in range(0,3):
    ...
    #c.Print("r009_tau32b1_20tev_04_after_cut_U.eps")
        ...
        #f=TFile("Dis_Rawhit_0.5GeV_"+files_array[j]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_after_cut_Man_25_no_UOF_new.root","RECREATE")
                #c.Print("Dis_Rawhit_0.5GeV_"+files_array[k]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_after_cut_Man.pdf")
                c.Print("Dis_Rawhit_0.5GeV_"+files_array[j]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_after_cut_Man_25_no_UOF_new.eps")
