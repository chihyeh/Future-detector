...
for k in range(0,3):
    ...
    #print "width="+str(width_array[1][i])
            f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
            G1=f1.Get("Graph")
            f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
...
#f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r009_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
            G2=f2.Get("Graph")
            f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
...
#mg.SetTitle("cluster_"+variable+"_"+energy1+"tev_eff_fixed_width_to_"+fixed_width1+"GeV_tt_qq ; signal efficiency; 1 - background efficiency")
            mg.SetTitle("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"_tev_eff_compare_error; signal efficiency; 1 - background efficiency")
...
#           leg1.SetBorderSize(0)
        ...
        #    leg1.AddEntry("","Z'("+str(energy_array[1][j])+"TeV)#rightarrowW^{+}W^{-}#rightarrow2 jets","")
            ...
            leg.SetTextFont(20)
            leg.SetBorderSize(0)
            leg.AddEntry(G1,"20 * 20 cm HCAL","l")
            leg.AddEntry(G2,"5  *  5 cm HCAL","l")
            leg.AddEntry(G3,"1  *  1 cm HCAL","l")
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
            ...
            leg.Draw()
            #leg1.Draw()
            c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"_tev_eff_compare_error.eps")
            c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"_tev_eff_compare_error.pdf")
