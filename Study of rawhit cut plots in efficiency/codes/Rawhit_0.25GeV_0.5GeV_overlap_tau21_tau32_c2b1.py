...
for k in range(0,3):
    for j in range(0,4):
        ...
        G3.SetLineStyle(5)
        G3.SetLineWidth(2)
        f4 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.5GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(7)
        G4.SetLineWidth(2)
        f5 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.5GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(9)
        G5.SetLineWidth(2)
        f6 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.5GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(10)
        G6.SetLineWidth(2)
        #G3.SetLineColor(5)
...
#c.Print("raw_"+variable+"_"+energy1+"tev_"+energy1_cut+"_compare_to_"+energy2_cut+"GeV_eff.pdf")
        ...
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root")
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.pdf")
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.eps")
