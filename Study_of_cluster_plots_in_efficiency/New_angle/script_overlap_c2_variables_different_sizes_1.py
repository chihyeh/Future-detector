...
for i in range(0,3):
    for j in range(0,4):
        ...
        f1 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_d2_b2_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        ...
        f4 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_d2_b2_mmdt_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(2)
        G4.SetLineColor(2)
        ...
        #G1=f1.Get("Graph")
        f2 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_m2_b2_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        ...
        f5 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_m2_b2_mmdt_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(2)
        G5.SetLineColor(3)
        ...
        #G2=f2.Get("Graph")
        f3 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_n2_b2_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        ...
        G3.SetLineWidth(3)
        G3.SetMarkerSize(0)
        f6 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_n2_b2_mmdt_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(2)
        G6.SetLineColor(5)
        G6.SetLineWidth(3)
        G6.SetMarkerSize(0)
        f7 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_d2_a1_b2_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G7=f7.Get("Graph")
        G7.SetLineStyle(1)
        G7.SetLineColor(7)
        G7.SetLineWidth(3)
        G7.SetMarkerSize(0)
        f8 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_d2_a1_b2_mmdt_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G8=f8.Get("Graph")
        G8.SetLineStyle(2)
        G8.SetLineColor(7)
        G8.SetLineWidth(3)
        G8.SetMarkerSize(0)
        f9 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_"+detector_size_array[i]+"_tau21_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G9=f9.Get("Graph")
        G9.SetLineStyle(5)
        G9.SetLineColor(9)
...
#mg.SetTitle("cluster_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+"; signal efficiency; 1 - background efficiency")
        mg.SetTitle(" ; signal efficiency; 1 - background efficiency")
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg = TLegend(0.1,0.1,0.6,0.6)
        leg.SetFillColor(0)
        leg.SetFillStyle(0)
        leg.SetTextSize(0.05)
        leg.SetTextFont(22)
        leg.SetBorderSize(0)
        leg.AddEntry(G1,"D_{2}^{2}","l")
        leg.AddEntry(G2,"M_{2}^{2}","l")
        leg.AddEntry(G3,"N_{2}^{2}","l")
        leg.AddEntry(G7,"D_{2}^{1,2}","l")
        leg.AddEntry(G4,"D_{2}^{2} #beta=0","l")
        leg.AddEntry(G5,"M_{2}^{2} #beta=0","l")
        leg.AddEntry(G6,"N_{2}^{2} #beta=0","l")
        leg.AddEntry(G8,"D_{2}^{1,2} #beta=0","l")
        leg.AddEntry(G9,"#tau_{21}","l")
        #leg.AddEntry(G1,"#tau_{32} #beta=1","l")
        #leg.AddEntry(G2,"#tau_{32} #beta=1.5","l")
        #leg.AddEntry(G3,"#tau_{32} #beta=2","l")
...
#c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.eps")
        c.Print("cluster_"+detector_size_array[i]+"_NA_b2_compare_soft_drop"+str(energy_array[1][j])+"tev_eff_1.pdf")
        c.Print("cluster_"+detector_size_array[i]+"_NA_b2_compare_soft_drop"+str(energy_array[1][j])+"tev_eff_1.eps")
