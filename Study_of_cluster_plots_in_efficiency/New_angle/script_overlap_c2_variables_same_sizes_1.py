...
variable_array=("d2_b1","m2_b1","n2_b1","d2_b2","m2_b2","n2_b2","d2_b1_mmdt","m2_b1_mmdt","n2_b1_mmdt","d2_b2_mmdt","m2_b2_mmdt","n2_b2_mmdt","d2_a1_b1","d2_a1_b2","d2_a1_b1_mmdt","d2_a1_b2_mmdt")
...
for k in range(0,16):
    for j in range(0,4):
        ...
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        f1 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G1=f1.Get("Graph")
        G1.SetLineStyle(1)
        G1.SetLineWidth(2)
        G1.SetMarkerSize(0)
        ...
        #G1=f1.Get("Graph")
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_5_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        f2 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G2=f2.Get("Graph")
        G2.SetLineStyle(3)
        G2.SetLineWidth(2)
        G2.SetMarkerSize(0)
        ...
        #G2=f2.Get("Graph")
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_7_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        f3 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/New_angle/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        G3=f3.Get("Graph")
        G3.SetLineStyle(5)
        G3.SetLineWidth(2)
        G3.SetMarkerSize(0)
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.SetTextFont(22)
        leg.SetBorderSize(0)
        leg.AddEntry(G1,"20#times20 cm HCAL","l")
        leg.AddEntry(G2,"5#times5 cm HCAL","l")
        leg.AddEntry(G3,"1#times1 cm HCAL","l")
...
#c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.eps")
        ...
        #c.Print("cluster_"+variable_array[k]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.pdf")
#c.Print("cluster_"+variable_array[k]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.eps")
...
#c.Print("raw_"+variable+"_"+energy1+"tev_"+energy1_cut+"_compare_to_"+energy2_cut+"GeV_eff.pdf")
        ...
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root")
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.pdf")
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.eps")
