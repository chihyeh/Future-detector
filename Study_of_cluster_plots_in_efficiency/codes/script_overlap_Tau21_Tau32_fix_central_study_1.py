...
#-----------------------------
    ...
    #-----------------------------------
        ...
        G6.SetLineColor(4)
        #-------------------
        f10= ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        G10=f10.Get("Graph")
        G10.SetLineStyle(1)
        G10.SetLineWidth(2)
        G10.SetLineColor(1)
        ...
        f11 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        G11=f11.Get("Graph")
        G11.SetLineStyle(1)
        G11.SetLineWidth(2)
        G11.SetLineColor(2)
        ...
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau21_b2_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        f12 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        G12=f12.Get("Graph")
        G12.SetLineStyle(1)
        G12.SetLineWidth(2)
        G12.SetLineColor(4)
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.AddEntry(G7,"20#times20 cm HCAL","l")
        leg.AddEntry(G8,"5#times5 cm HCAL","l")
        leg.AddEntry(G9,"1#times1 cm HCAL","l")
...
#        leg.AddEntry(G10,"20#times20 cm HCAL","l")
#        leg.AddEntry(G11,"5#times5 cm HCAL","l")
#        leg.AddEntry(G12,"1#times1 cm HCAL","l")
...
#       c.Print("cluster_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
        c.Print("cluster_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_Tradition.eps")
