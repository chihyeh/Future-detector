...
for k in range(0,2):
    ...
    #-------------------------------------------fixed width setting
                ...
                xarray=array("f",[])
                yarray=array("f",[])
                for e in range((central_energy/5)-(fixed_width/10-1),(central_energy/5)-(fixed_width/10-1)+9):
                    ...
                    print h1,h2
                    print '------------------'
                    xarray.append(h1.Integral(e,e+(fixed_width/5)-1)/a)
                    print '------------------'
                    yarray.append(1-h2.Integral(e,e+(fixed_width/5)-1)/b)
                print yarray
                print xarray
    ...
    #------------------------------------------set pictures and see the point of tex in
        ...
        #    d=4,e=7,f=4
                ...
                gr.SetMarkerColor(4)
                gr.SetMarkerStyle(3)
                gr.SetTitle("cluster_"+str(files_array[i])+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_eff_"+str(efficiency_number1)+"_width_fix_at_"+str(fixed_width)+"GeV_"+str(signal_we_want[l])+"_qq")
        ...
        #c.Draw()
                ...
                f=TFile("A_Cluster_"+str(files_array[i])+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_eff_"+str(efficiency_number1)+"_width_fix_at_"+str(fixed_width)+"GeV_"+str(signal_we_want[l])+"_qq.root","RECREATE")
        #f=TFile("raw_"+files+"_"+variable+"_"+energy1+"tev_"+energy1_cut+"GeV_eff.root","RECREATE");
                gr.Write()


        #leg.Draw()
                c.Print("A_Cluster_"+str(files_array[i])+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_eff_"+str(efficiency_number1)+"_width_fix_at_"+str(fixed_width)+"GeV_"+str(signal_we_want[l])+"_qq.pdf")
