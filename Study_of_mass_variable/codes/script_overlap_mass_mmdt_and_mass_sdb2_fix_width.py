...
#----------------------------------------------------
                ...
                f1= ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/A_Cluster_010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_width_fix_at_"+str(fixed_width)+"GeV_"+signal_we_want[d]+"_qq.root",'r')
                G1=f1.Get("Graph")
                G1.SetLineStyle(1)
                ...
                f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/A_Cluster_009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_width_fix_at_"+str(fixed_width)+"GeV_"+signal_we_want[d]+"_qq.root",'r')
                G2=f2.Get("Graph")
                G2.SetLineStyle(7)
                ...
                f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/A_Cluster_012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_width_fix_at_"+str(fixed_width)+"GeV_"+signal_we_want[d]+"_qq.root",'r')
                G3=f3.Get("Graph")
                G3.SetLineStyle(10)
...
#       c.Print("cluster_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
                c.Print("A_Cluster_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_width_fix_at_"+str(fixed_width)+"GeV_"+signal_we_want[d]+"_qq.eps")
