...
#-----------------------------
        ...
        f4 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Ratio/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log_New2_50%.root",'r')
        ...
        G4.SetLineColor(2)
        G4.SetLineWidth(2)
        f5 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Ratio/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log_New2_50%.root",'r')
        ...
        G5.SetLineColor(3)
        G5.SetLineWidth(2)
        f6 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Ratio/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log_New2_50%.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(10)
        G6.SetLineColor(4)
        G6.SetLineWidth(2)
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
        ...
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_eff_1_New2_after_cut.eps")
