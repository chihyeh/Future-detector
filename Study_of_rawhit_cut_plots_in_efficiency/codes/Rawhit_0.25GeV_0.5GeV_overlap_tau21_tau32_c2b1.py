...
for k in range(0,3):
    for j in range(0,4):
        ...
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        f1 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G1=f1.Get("Graph")
        G1.SetLineStyle(1)
        G1.SetLineWidth(2)
        #G1.SetLineColor(2)
        ...
        #G1=f1.Get("Graph")
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_5_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        f2 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G2=f2.Get("Graph")
        G2.SetLineStyle(3)
        G2.SetLineWidth(2)
        #G2.SetLineColor(3)
        ...
        #G2=f2.Get("Graph")
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b1_7_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        f3 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G3=f3.Get("Graph")
        G3.SetLineStyle(5)
        G3.SetLineWidth(2)
        f4 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(7)
        G4.SetLineWidth(2)
        f5 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(9)
        G5.SetLineWidth(2)
        f6 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(10)
        G6.SetLineWidth(2)
        #G3.SetLineColor(5)
        ...
        #G3=f3.Get("Graph")
        #f4 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c2b2_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        #G4=f4.Get("Graph")
        #G4.SetLineStyle(10)
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.SetTextFont(22)
        leg.SetBorderSize(0)
        leg.AddEntry(G1,"20#times20 cm HCAL(0.25GeV)","l")
        leg.AddEntry(G2,"5#times5 cm HCAL(0.25GeV)","l")
        leg.AddEntry(G3,"1#times1 cm HCAL(0.25GeV)","l")
        leg.AddEntry(G4,"20#times20 cm HCAL(0.5GeV)","l")
        leg.AddEntry(G5,"5#times5 cm HCAL(0.5GeV)","l")
        leg.AddEntry(G6,"1#times1 cm HCAL(0.5GeV)","l")
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
        ...
        leg1.Draw()
        c.SetLogy()
        #c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff_log.eps")
#c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff_log.eps")
        ...
        #c.Print("cluster_"+variable_array[k]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff_log.pdf")
#c.Print("cluster_"+variable_array[k]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff_log.eps")
...
#c.Print("raw_"+variable+"_"+energy1+"tev_"+energy1_cut+"_compare_to_"+energy2_cut+"GeV_eff.pdf")
        ...
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root")
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.pdf")
        c.Print("Rawhit_0.25GeV_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.eps")
