...
for k in range(0,3):
    for j in range(0,4):
        ...
        G3.SetLineStyle(5)
        G3.SetLineWidth(2)
        f4 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(7)
        G4.SetLineWidth(2)
        f5 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(9)
        G5.SetLineWidth(2)
        f6 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(10)
        G6.SetLineWidth(2)
        #G3.SetLineColor(5)
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.AddEntry(G4,"20#times20 cm HCAL(cluster)","l")
        leg.AddEntry(G5,"5#times5 cm HCAL(cluster)","l")
        leg.AddEntry(G6,"1#times1 cm HCAL(cluster)","l")
...
#c.Print("raw_"+variable+"_"+energy1+"tev_"+energy1_cut+"_compare_to_"+energy2_cut+"GeV_eff.pdf")
        ...
        c.Print("Rawhit_0.25GeV_cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.root")
        c.Print("Rawhit_0.25GeV_cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.pdf")
        c.Print("Rawhit_0.25GeV_cluster_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff_log.eps")
