    ...
    if(variable[k]=="tau21"):
        for m in range(0,4):
            for i in range(0,3):
                ...
                f=TFile("Rawhit_0.25GeV_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff_log.root","RECREATE")
                gr.Write()
                c.Print("Rawhit_0.25GeV_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff_log.pdf")
