...
for k in range(0,2):
    if(variable[k]=="tau21"):
        ...
        #-----------------------------------
                    if(h3.GetBinContent(L-1)==h3.GetBinContent(R+1)):
                        if(h3.GetBinContent(L-1)==0 and h3.GetBinContent(R+1)==0):
                            ...
                            if(Random==2):
                                ...
                                print '----15'
                        #------------------------------------------
                if(h3.Integral(0,L-1)==0 and h3.Integral(R+1,100)==0):
                    break
                n=R-L
                print n
                ...
                f=TFile("Rawhit_0.25GeV_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff_log_New2.root","RECREATE")
                gr.Write()
                c.Print("Rawhit_0.25GeV_r"+files_array[i]+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_04_eff_log_New2.pdf")
