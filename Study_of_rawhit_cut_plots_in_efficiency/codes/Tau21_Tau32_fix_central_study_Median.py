    ...
    #-------------------------------------------setting the starting point
        ...
        #------------------------------------------set pictures and see the point of tex in
            ...
            #c.Draw()
                    ...
                    f=TFile("A_Rawhit_0.25GeV_"+str(files_array[i])+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_eff_"+str(efficiency_number1)+"_central_fix_at_"+central_energy1+"GeV_"+str(signal_we_want[l])+"_qq_Med_log.root","RECREATE")
            #f=TFile("raw_"+files+"_"+variable+"_"+energy1+"tev_"+energy1_cut+"GeV_eff.root","RECREATE");
                    gr.Write()
                    c.Print("A_Rawhit_0.25GeV_"+str(files_array[i])+"_"+variable[k]+"_"+str(energy_array[1][m])+"tev_eff_"+str(efficiency_number1)+"_central_fix_at_"+central_energy1+"GeV_"+str(signal_we_want[l])+"_qq_Med_log.pdf")
