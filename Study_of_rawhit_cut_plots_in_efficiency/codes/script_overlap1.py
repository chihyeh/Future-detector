...
for k in range(0,3):
    for j in range(0,4):
        ...
        f1 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r010_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        #f1= ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r010_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        G1=f1.Get("Graph")
        G1.SetLineStyle(1)
        G1.SetLineWidth(3)
        f2 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r009_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r009_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        G2=f2.Get("Graph")
        G2.SetLineStyle(7)
        G2.SetLineWidth(3)
        f3 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r012_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r012_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        G3=f3.Get("Graph")
        G3.SetLineStyle(10)
        G3.SetLineWidth(3)
            #f4 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_"+detector_size_array[i]+"_c2b1_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
            #G4=f4.Get("Graph")
...
#mg.SetTitle("Rawhit_0.25GeV_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+"; signal efficiency; 1 - background efficiency")
...
#leg.AddEntry("G4","#sqrt{s}=40TeV","l")
        ...
        leg1.Draw()
        #leg1.Draw()
        #c.Print("Rawhit_0.25GeV_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_fixed_width_to_40GeV_"+signal_we_want[k]+"_qq.eps")
        #c.Print("Rawhit_0.25GeV_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_fixed_width_to_40GeV_"+signal_we_want[k]+"_qq.pdf")
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.pdf")
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.eps")
