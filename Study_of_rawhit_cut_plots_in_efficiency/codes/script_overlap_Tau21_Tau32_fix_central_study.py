...
#-----------------------------
    ...
    #-----------------------------------
        ...
        f13= ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        G13=f13.Get("Graph")
        G13.SetLineStyle(1)
        G13.SetLineWidth(2)
        G13.SetLineColor(1)
        ...
        f14 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        G14=f14.Get("Graph")
        G14.SetLineStyle(1)
        G14.SetLineWidth(2)
        G14.SetLineColor(2)
        ...
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_"+detector_size_array[i]+"_tau21_b2_"+str(energy_array[1][i])+"tev_04_eff_error.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff.root",'r')
        f15 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        G15=f15.Get("Graph")
        G15.SetLineStyle(1)
        G15.SetLineWidth(2)
        G15.SetLineColor(4)
...
#       c.Print("Rawhit_0.25GeV_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][i])+"tev.eps")
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_New2.eps")
