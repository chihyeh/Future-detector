...
#-----------------------------
        ...
        if(variable_array[k]=="tau21"):
            signal_we_want="ww"
            f7= ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log.root",'r')
            G7=f7.Get("Graph")
            G7.SetLineStyle(2)
            G7.SetLineWidth(2)
            G7.SetLineColor(5)
            ...
            f8 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log.root",'r')
            G8=f8.Get("Graph")
            G8.SetLineStyle(4)
            G8.SetLineWidth(2)
            G8.SetLineColor(6)
            ...
            f9 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.25GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log.root",'r')
            G9=f9.Get("Graph")
            G9.SetLineStyle(6)
            G9.SetLineWidth(2)
            G9.SetLineColor(7)
        ...
        f4= ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Cluster_010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_1)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(1)
        G4.SetLineWidth(2)
        print f4
        ...
        f5 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Cluster_009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_2)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(3)
        G5.SetLineWidth(2)
        print f5
        ...
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau21_b2_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_"+variable_array[k]+"_"+str(energy_array[1][j])+"tev_04_eff.root",'r')
        f6 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Cluster_012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_3)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(5)
        G6.SetLineWidth(2)
...
#       c.Print("cluster_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_New_method.eps")
