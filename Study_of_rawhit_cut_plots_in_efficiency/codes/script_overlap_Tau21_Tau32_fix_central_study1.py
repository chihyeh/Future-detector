...
#-----------------------------
        ...
        if(variable_array[k]=="tau32"):
            signal_we_want="tt"
        f4= ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Rawhit_0.25GeV_010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_1)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(1)
        G4.SetLineWidth(2)
        print f4
        ...
        f5 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Rawhit_0.25GeV_009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_2)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(3)
        G5.SetLineWidth(2)
        print f5
        ...
        f6 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_cluster_plots_in_efficiency/codes/A_Rawhit_0.25GeV_012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_3)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(5)
        G6.SetLineWidth(2)
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.AddEntry(G7,"20#times20 cm HCAL(other)","l")
        leg.AddEntry(G8,"5#times5 cm HCAL(other)","l")
        leg.AddEntry(G9,"1#times1 cm HCAL(other)","l")
...
#       c.Print("cluster_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
        c.Print("Rawhit_0.25GeV_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_"+signal_we_want+"_qq_log_overlap.eps")
