...
#-----------------------------
        ...
        if(variable_array[k]=="tau32"):
            signal_we_want="tt"
        f4= ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/A_Rawhit_0.5GeV_010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_1)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G4=f4.Get("Graph")
        G4.SetLineStyle(1)
        G4.SetLineWidth(2)
        print f4
        ...
        f5 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/A_Rawhit_0.5GeV_009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_2)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G5=f5.Get("Graph")
        G5.SetLineStyle(3)
        G5.SetLineWidth(2)
        print f5
        ...
        f6 = ROOT.TFile.Open(" /Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/A_Rawhit_0.5GeV_012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_central_fix_at_"+str(central_energy_3)+"GeV_"+signal_we_want+"_qq_log.root",'r')
        G6=f6.Get("Graph")
        G6.SetLineStyle(5)
        G6.SetLineWidth(2)
        f7 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        ...
        G7.SetLineWidth(2)
        G7.SetColorLine(1)
        f8 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        ...
        G8.SetLineWidth(2)
        G8.SetColorLine(2)
        f9 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New.root",'r')
        ...
        G9.SetLineWidth(2)
        G9.SetColorLine(4)
        f10 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r010_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        #f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        #f1= ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r010_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        G10=f10.Get("Graph")
        G10.SetLineStyle(7)
        G10.SetLineWidth(2)
        G10.SetColorLine(6)
        f11 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r009_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r009_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        #f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r009_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        G11=f11.Get("Graph")
        G11.SetLineStyle(9)
        G11.SetLineWidth(2)
        G11.SetColorLine(7)
        f12 = ROOT.TFile.Open("/Users/ms08962476/github/Study_of_rawhit_cut_plots_in_efficiency/codes/Rawhit_0.5GeV_r012_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_04_eff_log_New2.root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_mass_sdb2_"+str(energy_array[1][j])+"tev_eff_1_width_40GeV_fix_"+signal_we_want[k]+".root",'r')
        #f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_r012_mass_mmdt_40tev_eff_1_width_40GeV_fix_tt.root",'r')
        G12=f12.Get("Graph")
        G12.SetLineStyle(10)
...
#       c.Print("cluster_"+detector_size_array[i]+"_tau21_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
    c.Print("Rawhit_0.5GeV_"+variable_array[k]+"_"+str(energy_array[1][i])+"tev_eff_1_New_New2.eps")
