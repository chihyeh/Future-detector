...
int *cut_ww(int files, int energy)
{
    ...
    TFile* f1 = TFile::Open(Form("/Users/ms08962476/FD/VHEPP/analyze/onlyhadron/tev%dmumu_pythia6_zprime%dtev_wwrfull%03d_onlyhadronic/radius0.4_jetsubstructure_tcalo_for_mmdt.root",energy,energy,files));
    cout << "============================================================================================================================================================" << endl;
    cout << Form("/Users/ms08962476/FD/VHEPP/analyze/onlyhadron/tev%dmumu_pythia6_zprime%dtev_wwrfull%03d_onlyhadronic/radius0.4_jetsubstructure_tcalo_for_mmdt.root",energy,energy,files) << endl;
    cout << "============================================================================================================================================================" << endl;
    TH1F *h1;
