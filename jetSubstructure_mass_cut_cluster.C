...
void jetSubstructure_mass_cut_cluster(float radius=0.4, int mode=0){
...
for ( int signal=0 ; signal <3 ; signal++)
{
    for ( int Dir=0 ; Dir <3 ; Dir++)
    {
        ...
        //======================This range is from the previous study================//
          ...
          {
          string outputFile = inputDir + "/radius" + Form("%0.1f",radius)+ "_jetsubstructure_" + treeName + "_mass_cut_for_"+Form("%s",Signal_use[signal])+".root";
          ...
          if(Signal_use[signal]=="qq")
          {
          string outputFile = inputDir + "/radius" + Form("%0.1f",radius)+ "_jetsubstructure_"+ treeName + "_mass_cut_for_ww.root";
          cout << "writing output to " << outputFile.data() << endl;
          cout << "====================================================================================================" << endl;
          TFile* outFile = new TFile(outputFile.data(),"recreate");
          for(int ih=0;ih<nhistos;ih++)
