...
void jetSubstructureee(string inputDir, float radius=0.4, int mode=0){
      ...
      for(int ih=0; ih < nhistos; ih++)
        {
            ...
            {
                cout << "Weird ! Mass is smaller than 1" << endl;
                cout << "=============================================================================" << endl;
                break;
            }
            else if(sub[ih][i]>xmax[ih])
            {
                ...
                cout<< "After trimming: " << xmax[ih]-1 << endl;
  ...
  string outputFile = inputDir + "/radius" + Form("%0.1f",radius)+ "_jetsubstructure_"+ treeName + "_for_sdb2_2400_no_UOF.root";
