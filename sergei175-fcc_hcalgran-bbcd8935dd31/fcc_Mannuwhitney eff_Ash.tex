...
\begin{center}
   ...
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_5tev_04_eff_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_10tev_04_eff_log.eps}
   }
   \subfigure[20 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_20tev_04_eff_log.eps}
   }
   \subfigure[40 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_40tev_04_eff_log.eps}
   }
\end{center}
...
\begin{center}
   \subfigure[5 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_5tev_04_eff_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_10tev_04_eff_log.eps}
   }
   \subfigure[20 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_20tev_04_eff_log.eps}
   }
   \subfigure[40 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_40tev_04_eff_log.eps}
   }
\end{center}
...
\begin{figure}
\begin{center}
   \subfigure[5 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Cluster_tau21_5tev_eff_1_central_fix_ww_qq_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Cluster_tau21_10tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[20 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Cluster_tau21_20tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[40 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Cluster_tau21_40tev_eff_1_central_fix_ww_qq_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:cluster_tau21}
...
\begin{center}
   \subfigure[5 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_5tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_10tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_20tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau21_40tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:cluster_tau21}
...
\begin{figure}
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_5tev_eff_1_central_fix_ww_qq_log.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_10tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_20tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_40tev_eff_1_central_fix_ww_qq_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
...
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_5tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_10tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_20tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.5GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau21_40tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau21}
...
\begin{figure}
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_5tev_eff_1_central_fix_ww_qq_log.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_10tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_20tev_eff_1_central_fix_ww_qq_log.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_40tev_eff_1_central_fix_ww_qq_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau21}
...
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_5tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_10tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_20tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau21_40tev_eff_1_central_fix_ww_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{21}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau21}
...
\begin{center}
   \subfigure[5 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_5tev_04_eff_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_10tev_04_eff_log.eps}
   }
   \subfigure[20 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_20tev_04_eff_log.eps}
   }
   \subfigure[40 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_40tev_04_eff_log.eps}
   }
\end{center}
...
\begin{center}
   \subfigure[5 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_5tev_eff_1_central_fix_tt_qq_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_10tev_eff_1_central_fix_tt_qq_log.eps}
   }
   \subfigure[20 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_20tev_eff_1_central_fix_tt_qq_log.eps}
   }
   \subfigure[40 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_40tev_eff_1_central_fix_tt_qq_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:cluster_tau21}
...
\begin{center}
   \subfigure[5 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_5tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_10tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_20tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV in cluster fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_tau32_40tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:cluster_tau21}
...
\begin{center}
   ...
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_5tev_04_eff_log.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_10tev_04_eff_log.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_20tev_04_eff_log.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_40tev_04_eff_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
...
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_5tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_10tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_20tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.5GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_05GeV_tau32_40tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau32}
...
\begin{center}
   ...
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_5tev_04_eff_log.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.25GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_10tev_04_eff_log.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.25GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_20tev_04_eff_log.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.25GeV] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_40tev_04_eff_log.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
...
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_5tev_eff_1_central_fix_tt_qq_log_4.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_10tev_eff_1_central_fix_tt_qq_log_4.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_20tev_eff_1_central_fix_tt_qq_log_4.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_40tev_eff_1_central_fix_tt_qq_log_4.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau21}
...
\begin{center}
   \subfigure[5 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_5tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}\hfill
   }
   \subfigure[10 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_10tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[20 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_20tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
   \subfigure[40 TeV rawhit cut at 0.25GeV fix central at Median] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_tau32_40tev_eff_1_central_fix_tt_qq_log_vs_New_method.eps}
   }
\end{center}
\caption{Signal efficiency versus background rejection rate using $\tau_{32}$.The energies of collision at (a)5, (b)10, (c)20, (d)40TeV are shown here. In each picture, the three ROC curves correspond to different detector sizes.}
\label{fig:rawhit_0.5GeV_tau21}
