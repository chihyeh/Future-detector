...
\begin{center}
   ...
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_5tev_eff_1_log.eps}\hfill
   }
   \subfigure[10 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_10tev_eff_1_log.eps}
   }
   \subfigure[20 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_20tev_eff_1_log.eps}
   }
   \subfigure[40 TeV in cluster] {
   \includegraphics[width=0.43\textwidth]{figs/cluster_c2b1_40tev_eff_1_log.eps}
   }
\end{center}
