...
\begin{figure}
\begin{center}
   \subfigure[5 TeV using Rawhit 0.25GeV cut method with New2 no cut Method] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_c2b1_5tev_eff_1_New2_no_cut_25bins.eps}\hfill
   }
   \subfigure[10 TeV using Rawhit 0.25GeV cut method with New2 no cut Method] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_c2b1_10tev_eff_1_New2_no_cut_25bins.eps}
   }
   \subfigure[20 TeV using Rawhit 0.25GeV cut method with New2 no cut Method] {
   \includegraphics[width=0.43\textwidth]{figs/Rawhit_025GeV_c2b1_20tev_eff_1_New2_no_cut_25bins.eps}
   }
   \subfigure[40 TeV using Rawhit 0.25GeV cut method with New2 no cut Method] {
