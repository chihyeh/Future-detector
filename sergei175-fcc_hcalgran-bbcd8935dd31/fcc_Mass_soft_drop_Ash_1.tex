...
In this section, we will use the soft drop method to distinguish the signal and background. We use the Median to find out the bin in the signal, and we use the upper bound to be the central to draw the ROC curves, using the symmetry way to do. Every time we draw one point by adding one bin both of sides.     
%50bins
\begin{figure}
\begin{center}
