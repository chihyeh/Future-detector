...
if(variable[k]=="tau21"):
    ...
    c.Print("raw_"+str(cut_value)+"_tau21_summary_U_after_cut.pdf")
    c.Print("raw_"+str(cut_value)+"_tau21_summary_U_after_cut.eps")
...
if(variable[k+1]=="tau32"):
    ...
    c.Print("raw_"+str(cut_value)+"_tau32_summary_U_after_cut.pdf")
    c.Print("raw_"+str(cut_value)+"_tau32_summary_U_after_cut.eps")
...
if(variable[k+2]=="c2b1"):
    ...
    c.Print("raw_"+str(cut_value)+"_c2b1_summary_U_after_cut.pdf")
    c.Print("raw_"+str(cut_value)+"_c2b1_summary_U_after_cut.eps")
