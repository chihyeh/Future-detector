...
for i in range(0,3):
    for j in range(0,4):
        ...
        #G1=f1.Get("Graph")
        f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau32_b1_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        ...
        #G2=f2.Get("Graph")
        f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_c3_b1_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
...
#leg.AddEntry(G6,"z'->qq(truth-level-1*1)","l")
        ...
        leg.AddEntry(G1,"#tau_{31}","l")
        leg.AddEntry(G2,"#tau_{32}","l")
        leg.AddEntry(G3,"c_{(3)}^{1}","l")
...
#c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.eps")
        c.Print("cluster_"+detector_size_array[i]+"_tau31_and_tau32_and_c3b1_compare_"+str(energy_array[1][j])+"tev.pdf")
        c.Print("cluster_"+detector_size_array[i]+"_tau31_and_tau32_and_c3b1_compare_"+str(energy_array[1][j])+"tev.eps")
