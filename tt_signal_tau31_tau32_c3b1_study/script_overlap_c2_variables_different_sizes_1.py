...
for i in range(0,3):
    for j in range(0,4):
        ...
        f1 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau32_b1_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        ...
        #G1=f1.Get("Graph")
        f2 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau32_b1_5_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
        ...
        #G2=f2.Get("Graph")
        f3 = ROOT.TFile.Open("/Users/ms08962476/MannWhitneyU/cluster_"+detector_size_array[i]+"_tau32_b2_"+str(energy_array[1][j])+"tev_04_eff_error.root",'r')
...
#c.Print("cluster_"+detector_size_array[i]+"_c_variable_"+str(energy_array[1][j])+"tev_04_eff.eps")
        c.Print("cluster_"+detector_size_array[i]+"_tau32_compare_different_beta_"+str(energy_array[1][j])+"tev.pdf")
        c.Print("cluster_"+detector_size_array[i]+"_tau32_compare_different_beta_"+str(energy_array[1][j])+"tev.eps")
